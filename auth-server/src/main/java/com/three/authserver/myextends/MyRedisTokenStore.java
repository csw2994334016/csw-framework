...
public class MyRedisTokenStore implements TokenStore {
    ...
    public void removeAccessToken(String tokenValue) {
        ...
        try {
            ...
            // 由于无法清除redis中的token，自己研究这么搞的
            stringRedisTemplate.boundHashOps(new String(accessKey)).delete(new String(accessKey));
            ...
            if (authentication != null) {
                ...
                // 由于无法清除redis中的token，自己研究这么搞的
                stringRedisTemplate.boundHashOps(new String(authToAccessKey)).delete(new String(authToAccessKey));
            }
        } finally {
            conn.close();
        }
