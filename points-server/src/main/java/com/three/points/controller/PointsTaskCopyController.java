...
public class PointsTaskCopyController {
    ...
    public PageResult<PointsTask> query(Integer page, Integer limit, String sortKey, String chargePersonId, String chargePersonName) {
        if (page != null && limit != null) {
            return pointsTaskService.query(new PageQuery(page, limit), StatusEnum.OK.getCode(), "3", sortKey, chargePersonId, chargePersonName);
        } else {
            return pointsTaskService.query(null, StatusEnum.OK.getCode(), "3", sortKey, chargePersonId, chargePersonName);
        }
    }
