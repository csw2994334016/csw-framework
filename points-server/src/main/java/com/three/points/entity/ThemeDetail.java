...
public class ThemeDetail implements Serializable {
    ...
    @Column(name = "emp_username", columnDefinition = "varchar(255) comment '人员工号'")
    ...
    @Column(name = "a_score", nullable = false, columnDefinition = "int(11) comment 'A分'")
    @ApiModelProperty("A分")
    private Integer aScore; // A分

    @Column(name = "b_score", nullable = false, columnDefinition = "int(11) comment 'B分'")
    @ApiModelProperty("B分")
